...
<body>	
	...
	<form class="form-download" method="get" id="download" action="watch">
		<h1 class="form-download-heading">Youtube Downloader</h1>
		<i>http://youtube.com/watch?v=</i>
<input type="text" name="v" id="v" placeholder="Video ID">
		<br><input class="btn btn-primary" type="submit" name="type" id="type" value="Download" />
